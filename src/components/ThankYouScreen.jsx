      ...
      {showXdcNetworkDetails && (
        <div className="xdc-network-details">
          ...
          <div className="network-info">
            <p><strong>Network Name:</strong> XDC Network</p>
            <p><strong>Chain ID:</strong> 50 </p>
            <p><strong>Currency Symbol:</strong> XDC</p>
            <p><strong>RPC URL:</strong> https://erpc.xinfin.network</p>
            <p><strong>Block Explorer:</strong> https://xdcscan.io</p>
          </div>
          <p className="network-note">MetaMask will prompt you to add this network. Please approve the request to connect.</p>
        </div>
      )}
