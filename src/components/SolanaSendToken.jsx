          ...
          <div className="currency-list">
            ...
            >
              ...
              <div className="currency-balance">
                <div className="currency-value">~${solanaData.value.toFixed(3)}</div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                {wallet.publicKey ? formatAddress(wallet.publicKey.toString()).charAt(0) : 'N'}
              </div>
              <div>
                <div style={{
                  fontWeight: 'bold',
                  ...
                  {wallet.publicKey ? formatAddress(wallet.publicKey.toString()) : 'Not Connected'}
                </div>
                <div style={{
                  fontSize: '14px',
            ...
            <div style={{ marginBottom: '25px' }}>
              ...
              <div style={{ 
                ...
                >
                  ...
                  <span style={{ fontSize: '18px', fontWeight: 'bold' }}>SOL</span>
